...
class Window(QDialog):
    ...
    def executeButton(self, path):
        ...
        if self.selected_operation == 0:
            ...
            logic.writeHidden(self, path, radio_text, pattern_text, order_text, length, text)
        else:
            length = (self.ui.spinBox_number.value() - 3) * 3
            logic.readHidden(self, path, radio_text, pattern_text, order_text, length)
